var RayMarcher = function(){
    ...
    function loadFragmentShader( fragmentUrl, callback, field )
    {
        this.loaded = false;
        ...
        req.onload = function (e) {
            shader = e.target.responseText.split("\n");
            shader = shader.slice(0,149).join("\n") + "\n" + field + "\n" + shader.slice(149).join("\n");
            scope.setFragmentShader( shader, callback );
        };
        req.send();
        return this;
    }
